			...
			<section className='case'>
				<div className='case-head'>
					...
					<p className='page-lede'>
						...
						employee compensation and bonuses. Built in React with React Context
						for cycle-wide state; keyframe animations smooth award entry and
						live budget updates. Filters span hundreds of employees across
						ratings, eligibility, reviewers, and award type, while the sidebar
			...
			<section className='case'>
				<div className='case-head'>
					...
					<p className='page-lede'>
						...
						Required careful unit handling (conventional vs.&nbsp;SI), age-band
						piecewise math, and instance-aware IDs so multiple calculators can
						coexist on a page. The embed below is the production component
						&mdash; same TSX, same dk-form styling, same math.
					</p>
				</div>
				<div className='case-demo'>
					<GfrDemo />
